...
export default function MovieCard({ children, className, movieId, imgSrc, title, employeeBooking = false }) {

	return (
		<div className={"col-6 col-lg-3 mb-4"}>
			<a href={(employeeBooking ? "/booking-window/" : "/booking/") + movieId} style={{ color: "black", textDecoration: "none" }}>
